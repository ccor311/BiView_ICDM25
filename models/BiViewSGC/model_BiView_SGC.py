import torch
from models.BiViewSGC.SGConvMaskConv import SGConvMaskConv
from torch_geometric.nn import global_mean_pool as gap, global_max_pool as gmp
import torch.nn.functional as F
from torch_geometric import utils
from torch_sparse import mul

class BiViewSGC(torch.nn.Module):
    def __init__(self, args):
        super(BiViewSGC, self).__init__()
        self.args = args
        ...
        for i in range(self.num_layers):
            ...
            self.hom_conv_layers.append(SGConvMaskConv(in_features, out_features))

            #Heterophily Conv Layer
            self.het_conv_layers.append(SGConvMaskConv(in_features, out_features))
    ...
    def forward(self, data, last_epoch):
        #Masks are the heterophily/homophily masks
