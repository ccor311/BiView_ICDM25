import torch
from models.BiViewGCN.GCNMaskConv import GCNConv
from torch_geometric.nn import global_mean_pool as gap, global_max_pool as gmp
import torch.nn.functional as F
from torch_geometric import utils
from torch_sparse import mul

class BiViewGCN(torch.nn.Module):
    def __init__(self, args):
        super(BiViewGCN, self).__init__()
        self.args = args
        ...
        for i in range(self.num_layers):
            ...
            self.hom_conv_layers.append(GCNConv(in_features, out_features))

            #Heterophily Conv Layer
            self.het_conv_layers.append(GCNConv(in_features, out_features))
