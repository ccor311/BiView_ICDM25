...
class BiView(torch.nn.Module):
    def __init__(self, args):
        super(BiView, self).__init__()
        self.args = args
        ...
        for i in range(self.num_layers):
            ...
            self.het_conv_layers.append(HeterophilyAttentionGATv2(in_features, out_features, edge_dim=1))
        ...
        self.layer_weights = torch.nn.Parameter(torch.rand(self.num_layers, 2*self.nhid))
